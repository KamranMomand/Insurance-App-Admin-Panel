...
<div class="container" onload="load()" style="margin-top: 50px;">

    <div class="card card-default">
        <h4 class="text-center" style="padding-top:45px;"><span style="color:#FF4A23;">Types Of Policy</span> Section</h4><br>
        <h5 style="padding-left:45px;">Add Types Of Policy</h5>
        <div class="card-body">
            <form id="addUser" class="form-inline" method="POST" action="">
                ...
                <button id="submitUser" type="button" style="background-color:#FF4A23;" class="btn btn-primary mb-2">Add
                Types Of Policy</button>
            </form>
        </div>
    </div>
    <br>
    <h5>Types Of Policy List </h5>
...
$('#submitUser').on('click', function() {
    ...
    firebase.database().ref('Types Of Policy/' + categoryID).set({
        name: name,
        id: categoryID,
    });
...
$('body').on('click', '.updateData', function() {
    ...
    firebase.database().ref('Types Of Policy/' + updateID).on('value', function(snapshot) {
...
$('.updateUser').on('click', function() {
    ...
    var updates = {};
    updates['/Types Of Policy/' + updateID] = postData;
...
$('.deleteRecord').on('click', function() {
    ...
    firebase.database().ref('Types Of Policy/' + id).remove();
